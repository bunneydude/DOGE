...
void setup()
{
  ...
  myProtocol.serial_registers[SREG_PING] = 1;
...
void loop(){
   ...
   if(myProtocol.serial_registers[SREG_PING] != 0){
      ...
      if( (myProtocol.serial_registers[SREG_PING] & 0x3) == 0x1){
         ...
         if((myProtocol.serial_registers[SREG_PING] & 0x4) == 0x1){
            //read temperature
      ...
      if(myProtocol.serial_registers[SREG_PING] == 0x2){
        //set to 0x1
        myProtocol.serial_registers[SREG_PING] = 0x1;
      }else{
        //set to 0x2
        myProtocol.serial_registers[SREG_PING] = 0x2;
      }
